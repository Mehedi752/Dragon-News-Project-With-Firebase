...
//   console.log(location)
  ...
  return (
    <div className='container mx-auto px-[300px] py-[100px]'>
      <div className='bg-white px-[96px] py-[76px]'>
          ...
          <form onSubmit={handleLogin} className=''>
            ...
            <div className='form-control'>
              ...
              {errorMessage.message ? (
                <p className='text-red-600 mt-3 text-xs'>{errorMessage.message}</p>
              ) : (
                <label className='label'>
        ...
        <h3 className='text-[#706f6f] text-center text-base font-semibold'>
          ...
          <Link className='text-[#ff8c47]' to={'/auth/register'}>
            Register
          </Link>
        </h3>
      </div>
